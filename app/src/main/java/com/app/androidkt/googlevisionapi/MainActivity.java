...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private static final int CAMERA_REQUE
    ST_CODE = 102;
    String[] msg = new String[2];
    String o1="i think this is a ";
    String o2="or may be";
    private static final String CLOUD_VISION_API_KEY = "AIzaSyC9u7xF9sUhpESQ2fB1KXV_lCxnUy_VIdo";
    int i=0;
    ...
    private void callCloudVision(final Bitmap bitmap, final Feature feature) {
        ...
        new AsyncTask<Object, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                ...
                String myText="";
                if(msg[0]!=null){
                    myText="I Think it is "+msg[0];
                }
                if(msg[1]!=null){
                    myText= myText +" or it may be "+msg[1];
                }

                t1.speak(myText, TextToSpeech.QUEUE_FLUSH, null,null);
